========================================================================
    APLICACIÓN DE CONSOLA: ColasCirculares_Consola Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación ColasCirculares_Consola.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación ColasCirculares_Consola.


ColasCirculares_Consola.vcxproj
...
ColasCirculares_Consola.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado ColasCirculares_Consola.pch y un archivo de tipos precompilados llamado StdAfx.obj.
